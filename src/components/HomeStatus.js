          ...
          <div className='row'>
            ...
            <div>
              ...
              <div className="lmc-home-card">
                ...
                <div className="lmc-home-card-footer">
                  <div className="lmc-flex-container">
                    <p>No incidents</p><Link to="#"><button className="_vvlgt62 _17tu3a" type="button">View All</button></Link>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="lmc-home-card-footer">
                  <div className="lmc-flex-container">
                    <div Style="max-width: 145px;">
                      <Link to="#"><button className="_vvlgt62 _iprbgp z-depth-4" type="button"><i className="_1f7qr6a2 octicon octicon-plus" Style="margin-right: 0.5em;"></i><span>Add To-Do</span></button></Link>
                    </div>
                    <div Style="max-width: 95px;">
                      <Link to="/todolist"><button className="_vvlgt62 _17tu3a" type="button">View All</button></Link>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="lmc-home-card" Style="display: flex; flex-direction: column; justify-content: space-between;">
                ...
                <div className="lmc-home-card-footer">
                  <div className="lmc-flex-container">
                    <div Style="align-self: center;">
                      <a className="lmc-glyph-link" href="#" rel="noreferrer" Style="display: inline-block; float: left; margin-top: 0px;" target="_blank"><i className="_sea18i0 octicon octicon-question" Style="padding-right: 6px;"></i>Help</a>
                    </div>
                    <div Style="max-width: 95px;">
                ...
                <div className="col-xl-6 col-md-6 col-sm-6">
            <div>
              <h2 className="lmc-home-card-title">UPCOMING SERVICE USERS Birthdays</h2>
              <div className="lmc-home-card">
                <div className="lmc-home-card-body" Style="height: 250px;">
                  <div Style="max-height: 238px; overflow-y: auto;">
                    <ul>
                      <li className="lmc-resident-list-item lmc-no-underline" Style="display: flex; padding: 7px 0px 7px 7px;">
                        <Link to="#" Style="width: 100%;">
                        <div>
                          <div className="lmc-profile-picture" Style="float: left; margin-left: 3px; background-repeat: no-repeat; background-position: center center; display: flex; align-items: center; justify-content: center; background-image: url(&quot;https://lamavie.ml/wisterias/assets/img/dashboard/patient-4.jpg&quot;);"></div>
                          <div Style="position: relative; color: rgb(34, 34, 34); padding-left: 10px; padding-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            <span><span Style="opacity: 0.7; font-size: 11px; position: relative; font-weight: 600; letter-spacing: 0.4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">asdsa sdfsdfsD<br/></span> <span Style="top: -2px; position: relative;">36 years old on Tuesday 1st Feb</span></span>
                          </div>
                        </div></Link>
                      </li>
                      <li className="lmc-resident-list-item lmc-no-underline" Style="display: flex; padding: 7px 0px 7px 7px;">
                        <Link to="#" Style="width: 100%;">
                        <div>
                          <div className="lmc-profile-picture" Style="float: left; margin-left: 3px; background-repeat: no-repeat; background-position: center center; display: flex; align-items: center; justify-content: center; background-image: url(&quot;https://lamavie.ml/wisterias/assets/img/dashboard/patient-6.jpg&quot;);"></div>
                          <div Style="position: relative; color: rgb(34, 34, 34); padding-left: 10px; padding-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            <span><span Style="opacity: 0.7; font-size: 11px; position: relative; font-weight: 600; letter-spacing: 0.4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">ada lol<br/></span> <span Style="top: -2px; position: relative;">58 years old on Tuesday 22nd Feb</span></span>
                          </div>
                        </div></Link>
                      </li>
                      <li className="lmc-resident-list-item lmc-no-underline" Style="display: flex; padding: 7px 0px 7px 7px;">
                        <Link to="#" Style="width: 100%;">
                        <div>
                          <div className="lmc-profile-picture" Style="float: left; margin-left: 3px; background-repeat: no-repeat; background-position: center center; display: flex; align-items: center; justify-content: center; background-image: url(&quot;https://lamavie.ml/wisterias/assets/img/dashboard/patient-2.jpg&quot;);"></div>
                          <div Style="position: relative; color: rgb(34, 34, 34); padding-left: 10px; padding-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            <span><span Style="opacity: 0.7; font-size: 11px; position: relative; font-weight: 600; letter-spacing: 0.4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Ted smith<br/></span> <span Style="top: -2px; position: relative;">71 years old on Saturday 2nd Apr</span></span>
                          </div>
                        </div></Link>
                      </li>
                    </ul>
